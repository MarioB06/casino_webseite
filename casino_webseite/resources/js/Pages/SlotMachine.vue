...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Slot Machine</h2>
        </template>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div style="font-weight: bold; text-align: center;">
                    <div class="p-6 text-gray-900 dark:text-gray-100" style="">
                        <p style="font-size: 2rem;">Slot Machine</p>
                        <br>
                        <p style="font-size: 1rem;">1. Wählen Sie einen Einsatz <br>
                            2. Drehn Sie die Walzen, indem Sie uf "Spielen" drücken <br>
                            3. Falls die Symbole übereinstimmen, gewinnen Sie
                        </p>
                    </div>
                </div>
